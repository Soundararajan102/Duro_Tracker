...
class Bill: pass
class BillItem: pass
class ExpenseEntry: pass
class InventoryCategory: pass
class InventoryItem: pass
class InventoryItemCategory: pass
class InventoryMovement: pass
class InventoryMovementType: pass
class InventoryTransfer: pass
class Item: pass
class Organization: pass
class Payment: pass
class Retailer: pass
class RetailerPayment: pass
class RetailerSale: pass
class Shop: pass
class ShopInventoryAllocation: pass
class TransferShop: pass


AdminReportDetailLevel = str
AdminReportSection = str
AnalyticsPeriod = str

from app.core.timezone import to_ist
def _get_period_bounds(*args, **kwargs): pass
def format_retailer_sale_bill_no(*args, **kwargs): pass
def list_organization_shops(*args, **kwargs): pass
